...
% However, in a production ML setting, such decisions quickly become implicit expectations since data constantly evolve and changes, as a reflection of the real world. These implicit expectations must be translated to more explicit, analytical tests which fail when our assumptions and expectations no longer hold.
...
% TODO This paper is organised as follows...
...
% NOTE discuss the pros and cons of having a qualiative assessment: they are dense with useful information; humans need visual patterns!
