...
% TODO what were the primary findings of this study?
...
% TODO include shrestha2023detangler
...
% TODO perhaps this requires more clarification? What do we mean that they could not be "readily" applied?
...
% TODO I think its not clear that the qualitative assessment of notes was done to identify the 90 notebooks?
...
% TODO repeat of what we say for Figure 2.
...
% TODO transition between methodology and results is not strong. Specifically, Phase 3 of the analysis is not substantial. The distinction between the vis-assert pairs and the ML testing tasks is not clear. We need to describe that the vis-assert pairs are used to accomplish the ML testing tasks.
...
% TODO discuss that we only consider viz-assert pairs that could be readily applied to ML development lifecycle. However, we also found several visualisation-assert pairs that target the more fundamental concepts of ML. Further work is required to explore such pairs and check if they are useful...
%
