...
% front-end which parses the JSON
% there is also the kernel which is a process running in the background, the frontend communicates with the kernel; send input (code cell) and get output (result of execution)
