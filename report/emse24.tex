...
\highlight{\textbf{Finding 1.1} The study identifies seven outputs used to check data distribution, including visualisations like categorical plots, KDE plots, and count plots (O2, O9 and O25), and statistical summaries from pandas dataframes (O14 and O48). These checks are used for making informed decisions about data transformations such as scaling, normalizing and handling outliers, ensuring data integrity and improving model training reliability during the EDA phase.}
