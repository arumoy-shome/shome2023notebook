...
We took several measures to mitigate this threat as described in Section~\ref{sec:method}).
However, once the codebook stabilized,
the remaining statements
are coded by a single researcher,
