...
Our corpus consists of 816 validation statements,
collected from GH ($n=383$, 46\%) and KG ($n=433$, 54\%).
The validation statements consist of two top level intent codes
EXP (n=692, 85\%) and VAL (n=123, 15\%).

% Intent x Source

% TODO: Normalize all barplots by percentage
...
\begin{figure}
  ...
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{distribution-intent-exp.pdf}
    \caption{Distribution of the EXP sub-types across GH and KG, normlized by source.}
    \label{fig:distribution-intent-exp}
  \end{subfigure}
  \begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{distribution-intent-val.pdf}
    \caption{Distribution of all VAL sub-types.}
    \label{fig:distribution-intent-val}
  \end{subfigure}
  \caption{\textcolor{red}{TODO}: think of a better caption.}\label{fig:distribution-intent-all}
\end{figure}

% \begin{figure}
%   \begin{center}
%     \includegraphics[width=0.95\textwidth]{distribution-intent.pdf}
%     \caption{Distribution of the intent (EXP vs.\ VAL) across GH and KG, normalized by source.}\label{fig:distribution-intent}
%   \end{center}
% \end{figure}

% \begin{figure}
%   \begin{center}
%     \includegraphics[width=0.95\textwidth]{distribution-intent-exp.pdf}
%   \end{center}
%   \caption{Distribution of the EXP sub-types across GH and KG, normlized by source.}\label{fig:distribution-intent-exp}
% \end{figure}

% \begin{figure}
%   \begin{center}
%     \includegraphics[width=0.95\textwidth]{distribution-intent-val.pdf}
%   \end{center}
%   \caption{Distribution of all VAL sub-types.}\label{fig:distribution-intent-val}
% \end{figure}
