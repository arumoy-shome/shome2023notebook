...
Assertions are therefore a suitable candidate for studying validation behaviour,
...
\begin{description}
  \item[RQ1.] \textbf{How prevalent are exploratory and validation feedback statements in ML notebooks?}
  ...
  \item[RQ2.] \textbf{What do practitioners intend to learn or confirm from feedback statements?}
  ...
  \item[RQ4.] \textbf{How does the feedback taxonomy relate to known crash modes in ML notebooks?}
    ...
    and find that both taxonomies converge on data preparation
    as the empirical centre of gravity in ML notebook development.
...
\textbf{First},
we provide an empirical characterization of feedback practice in ML Jupyter notebooks,
...
\textbf{Third},
using the mapping between our feedback taxonomy
and the crash taxonomy of Wang et al.~\cite{wang2025why},
we surface the duality between
defensive programming practice and observed failure
in ML Jupyter notebooks,
and identify regions of the failure space that crash analysis alone cannot capture.
\textbf{Finally},
