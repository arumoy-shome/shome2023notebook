...
\begin{description}
  ...
  \item[RQ4.] \textbf{How does the feedback taxonomy relate to known crash modes in ML notebooks?}
    ...
    as the empirical center of gravity in ML notebook development.
...
indicating a highly significant and large association
...
and the direction of the association match our prediction.
...
which yields $\kappa = 0.93$ for intent and $\kappa = 0.94$ for stage
on 22\% of the residual sample.
