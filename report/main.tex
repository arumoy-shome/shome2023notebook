...
\begin{figure}
 ...
 \caption{Overview of the methodology.}\label{fig:method}
\end{figure}

The research goal of this study
is to \emph{characterize} the feedback statements used in ML Jupyter notebooks.
...
% NOTE: can cut this if space required
...
We use UMAP~\cite{McInnes2018} to reduce the embedding dimentionality to 10,
...
are retrained as individual strata.
...
Following this the first author analyzes and codes all remaining statements.

While conducting the manual analysis,
we observe 91 feedback statements that are not within the scope of this study.
For instance,
