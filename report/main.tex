...
All expected cell frequencies exceed 5(min = 57.7), and satisfy the validity conditions of the test.
...
\subsection{RQ2: Intent Taxonomy of Validation Statements}
...
\subsection{RQ3: Pipeline Stage Distribution of Validation Statements}
